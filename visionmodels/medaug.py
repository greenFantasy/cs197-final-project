...
DEFAULT_MODEL_CHECKPOINT_FNAME = "medaug_mimic-cxr_resnet50.pth.tar"
DEFAULT_MODEL_CHECKPOINT_PATH = os.path.join(get_pretrained_dir(), 
                                             DEFAULT_MODEL_CHECKPOINT_FNAME)

def _medaug(checkpoint_path=DEFAULT_MODEL_CHECKPOINT_PATH, device="cuda" if torch.cuda.is_available() else "cpu"):
