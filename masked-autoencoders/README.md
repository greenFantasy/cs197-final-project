### This repo is forked from Facebook's implementation of Masked Autoencoders for Masked Image Modeling 
### We're utilizing this pipeline to pretrain a vision transformer for zero-shot pathology classification on chest X-rays. The file PRETRAIN.md contains information about how we pretrained on chest Xrays.
